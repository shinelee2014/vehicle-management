...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'admin/users', name: 'AdminUsers', component: () => import('@/views/admin/Users.vue'), meta: { title: '用户管理', module: 'admin_users' } },
      { path: 'admin/posts', name: 'AdminPosts', component: () => import('@/views/admin/Posts.vue'), meta: { title: '岗亭管理', module: 'admin_posts' } },
      { path: 'admin/configs', name: 'AdminConfigs', component: () => import('@/views/admin/Configs.vue'), meta: { title: '系统配置', module: 'admin_configs' } },
      { path: 'admin/role-modules', name: 'AdminRoleModules', component: () => import('@/views/admin/RoleModules.vue'), meta: { title: '角色权限', module: 'admin_role_modules' } },
      { path: 'admin/vehicle-types', name: 'AdminVehicleTypes', component: () => import('@/views/admin/VehicleTypes.vue'), meta: { title: '车辆类型', module: 'admin_vehicle_types' } },
